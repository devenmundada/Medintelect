...
import { Calendar, Phone, Video, Users, Heart, Star, CheckCircle, MapPin, Clock, Award, Shield } from 'lucide-react';
    ...
    <div className="flex flex-col lg:flex-row">
      ...
      <div className="lg:w-2/3 p-6">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-1">
              {doctor.languages.map((lang) => (
                <span key={lang} className="px-2 py-1 bg-neutral-100 dark:bg-neutral-800 rounded text-xs">{lang}</span>
              ))}
            </div>
          </div>
        ...
        <div className="flex space-x-3">
          <Button onClick={() => onBook(doctor.id)} className="flex-1" leftIcon={<Calendar className="w-4 h-4" />}>Book Appointment</Button>
